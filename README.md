...
- **F2 / F3 / F4** — Setup dual scan-based pickers + same-output reject; dual Chromium; Welcome clear/change restarts kiosk; Ubuntu Server lab checklist — [INSTALL.md §7b / §7c](INSTALL.md), [ARCHITECTURE.md §4a](ARCHITECTURE.md)
